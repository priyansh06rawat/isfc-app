 ...
 * 
 * Fetches the describe metadata of Connector__c to print all fields and check if they exist.
 */
...
async function main() {
  ...
  console.log('Fetching describe for Lead...');
  const res = await request(
    `${SF_INSTANCE_URL}/services/data/v59.0/sobjects/Connector__c/describe`,
    {
      headers: {
