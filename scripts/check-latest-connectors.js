...
async function getLatestConnectors() {
  ...
  const query = encodeURIComponent("SELECT Id, Name, Name__c, Mobile__c, CreatedDate FROM Connector__c ORDER BY CreatedDate DESC LIMIT 5");
